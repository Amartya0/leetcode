...
At any moment, you can set the initial direction of moving for some robot. Your target is to minimize the total distance traveled by all 
the robots.
...
def main():
    print(Solution().minimumTotalDistance([0, 4, 6], [[2, 2], [6, 2]]))  # 4
    print(Solution().minimumTotalDistance([1, -1], [[-2, 1], [2, 1]]))  # 2
